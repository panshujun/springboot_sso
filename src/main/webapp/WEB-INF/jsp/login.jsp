...
<head>
    ...
    <script src="${pageContext.servletContext.contextPath }/admin/assets/plugins/jquery/jquery-1.9.1.min.js"></script>
    <script src="${pageContext.servletContext.contextPath }/common/common.js"></script>
    <!--[if lt IE 9]>
            ...
            <table style="width: 100%">
                <tr>
                    <td align="left"><img
                            ...
                            alt="Logo"></td>
                    <td align="center" style="font-weight: bold;color: gray;">耀盛管理系统</td>
                    <td align="right"><img
                            src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
                            alt="Logo"></td>
                </tr>
            ...
            <div class="controls">
                <div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
                                ...
                                alt="请输入账号.."></span><input type="text" placeholder="username" id="userName" name="username" value="admin"
            ...
            <div class="controls">
                <div class="main_input_box">
						<span class="add-on bg_ly"><img
                                ...
                                alt="请输入密码.."></span><input type="password" placeholder="password" id="password" name="password" value="123456"
                                                            style="height: 32px; margin-bottom: 0px;"/>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function checkUserForm() {
        ...
        var body = '"userName":"'+$('#userName').val()+'","password":"'+$('#password').val()+'"';
        var param = 'data={"header":{"faceCode":"user.login"},"body":{'+body+'}}'
        $.ajax({
            ...
            success : function(obj) {
                var data = checkResponseData(obj);
                var respCode = data.header.respCode;
                debugger;
                if(1==respCode){
                    var user = data.body;
                    userId = user.userId;
